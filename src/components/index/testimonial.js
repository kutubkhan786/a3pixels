        ...
        <div class="row align-items-md-center text-white">
          <div class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    <div class="row">
                      <div class="col-sm-2 pt-3">
                        <img src="https://source.unsplash.com/300x300/?girl"
                          class="rounded-circle img-responsive img-fluid" alt=""/>
                      </div>
                      <div class="col-sm-10">
            ...
            <div class="controls push-right">
              <a class="left fa fa-chevron-left text-white" href="#carouselExampleCaptions"
                data-bs-slide="prev">.</a>
              <a class="right fa fa-chevron-right text-white" href="#carouselExampleCaptions"
